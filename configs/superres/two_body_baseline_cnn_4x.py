"""Super-Resolution (Trajectory Interpolation), Two Body Problem.
...
def get_config():
  ...
  model.q_dim = 2  # Two-body uses (r, theta) polar coordinates
  model.t_span = (0, 10)
  model.stage_step_size = (32, 8)  # Input at 32, output at 8 (4x upsampling)
  model.step_size = 8
  ...
  network.num_stages = 2  # Two stages for 4x upsampling
